...
class myMainWindow : public QMainWindow
{
	...
	QGroupBox * group_box_buttons;
	QGroupBox * group_box_parameters;
	...
	QLineEdit * line_edit_alpha;
	QLineEdit * line_edit_beta;
	QLineEdit * line_edit_gamma;
	QLineEdit * line_edit_delta;
	QLineEdit * line_edit_triangle;
	QLineEdit * line_edit_selected_triangle;
	QLineEdit * line_edit_k;
	QLineEdit * line_edit_noise_intensity;
	QLineEdit * line_edit_n_normal_its;
	QLineEdit * line_edit_n_vertex_its;
	QLineEdit * line_edit_n_external_its;
	QLineEdit * line_edit_n_bilateral_its;
	...
	QPushButton * push_button_precomputation;
	QPushButton * push_button_patch_computation;
	QPushButton * push_button_single_patch_computation;
	QPushButton * push_button_add_noise;
	QPushButton * push_button_run_robust_patch_algorithm;
	QPushButton * push_button_screenShot;
...
private:
	...
	void precomputation();
	void patch_computation();
	void showScalarFunction();
	void single_patch_computation();
	void single_patch_computation_idx();
	void updateSelectedFace();
	void addNoise();
	void runRobustPatchAlgorithm();
	void screenShot();
